...
struct ReplicaPoseEntry {
    ...
    //     orientation = Eigen::Quaternionf(std::stof(columns[4]), 
    //                                      std::stof(columns[5]), 
    //                                      std::stof(columns[6]),
    //                                      std::stof(columns[7]));
    // }
    ...
    //     Eigen::Vector3f t_wc = Eigen::Vector3f(std::stof(columns[1]), std::stof(columns[2]), std::stof(columns[3]));
    //     Eigen::Quaternionf q_wc = Eigen::Quaternionf(std::stof(columns[4]), 
    //                                                 std::stof(columns[5]), 
    //                                                 std::stof(columns[6]),
    //                                                 std::stof(columns[7]));
    //     std::cout << "<---------------------- Translation t: " << t_wc << std::endl;
    //     std::cout << "<---------------------- Quaternion q: " << q_wc << std::endl;
    //     orientation = q_wc.conjugate();
    //     position = -(orientation * t_wc);
    // }
