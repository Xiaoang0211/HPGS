...
class GSUpdater<Map<Data<Field::TSDF, ColB, SemB>, Res::Single, BlockSize>, SensorT> {
    ...
    const std::vector<std::tuple<Eigen::Vector2f, Eigen::Vector3f, float, int>>& keypoints_;
    ...
    torch::Tensor cur_gt_depth_;
    torch::Tensor cur_gt_img_gray_;
    torch::Tensor rgb_weights_;
